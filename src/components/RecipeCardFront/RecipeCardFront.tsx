          ...
          <div className={classes.rc_back__method}>
            <ul>
              <li>
                ...
                mixture resembles fine breadcrumbs. Add egg yolk and water,
                adding an extra teaspoon of water if needed. Process until dough
                just comes together. Turn out dough onto a lightly floured
              ...
              <li>
                ...
                round (base) loose-based fluted tart pan. Roll out pastry
                between 2 sheets of baking paper until 4mm thick. Line base and
                side of pan with pastry. Refrigerate for 10 minutes.
              </li>
              <li>
                <span>step 3</span>
                <br />
                Meanwhile, make White chocolate custard; Place cream and milk in
                a medium saucepan. Heat over medium-high heat until just
                simmering (do not boil). Remove from heat. Add chocolate. Stir
                until smooth and combined. Set aside for 15 minutes or until
                cool. Whisk in egg.
              </li>
              <li>
                <span>step 4</span>
                ...
                minutes or until edges are light golden. Remove weights and
                paper. Bake for a further 5 to 7 minutes or until base is light
